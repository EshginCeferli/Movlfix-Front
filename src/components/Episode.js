...
function Episode() {
  return (
    ...
    style={{ backgroundImage: "url(/images/bg/episode_bg.jpg)" }}
                    ...
                    <div className="card-body">
                      <ul>
                        <li>
                          ...
                          >
                            <i className="fas fa-play" /> Episode 1 - The World Is
                            Purple
                          </a>{" "}
                          <span className="duration">
                            <i className="far fa-clock" /> 28 Min
                          </span>
                        </li>
                        <li>
                          <a
                            ...
                            className="popup-video"
                          >
                            <i className="fas fa-play" /> Episode 2 - Meaner Than
                            Evil
                          </a>{" "}
                          <span className="duration">
                            <i className="far fa-clock" /> 28 Min
                        ...
                        <li>
                          <a
                            ...
                            className="popup-video"
                          >
                            <i className="fas fa-play" /> Episode 3 - I Killed a
                            Man Today
                          </a>{" "}
                          <span className="duration">
                            <i className="far fa-clock" /> 28 Min
                        ...
                        <li>
                          <a
                            ...
                            className="popup-video"
                          >
                            <i className="fas fa-play" /> Episode 4 - Cowboys and
                            Dreamers
                          </a>{" "}
                          <span className="duration">
                            <i className="far fa-clock" /> 28 Min
                        ...
                        <li>
                          <a
                            ...
                            className="popup-video"
                          >
                            <i className="fas fa-play" /> Episode 5 - Freight
                            Trains and Monsters
                          </a>{" "}
                          <span className="duration">
                            <i className="far fa-clock" /> 28 Min
